     ...
     $( itmRanger ).each(function () {
         ...
         $(this).slider({
            ...
            slide: function( event, ui ) {
                 $(this).siblings('.f-num').val( $(this).siblings('.f-num').val( "$" + $( "#slider-range" ).slider( "values", 0 );.slider( "values", 0 ));
                 $(this).siblings('.l-num').val( $(this).siblings('.f-num').val( "$" + $( "#slider-range" ).slider( "values", 0 );.slider( "values", 1 ));
            }
        });
     });
